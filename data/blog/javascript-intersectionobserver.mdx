...
date: '2025-03-19'
tags: ['JavaScript', 'React', '최적화', 'Real World']
---

## 이미지 최적화가 왜 필요할까

웹페이지에서 **이미지는 가장 큰 리소스 중 하나**로, 무분별하게 로드하면 성능 저하와 사용자 경험(UX) 악화로 이어질 수 있습니다. 실시간 채팅 서비스에서 느린 이미지 로딩 문제를 `IntersectionObserver`로 해결했습니다.
